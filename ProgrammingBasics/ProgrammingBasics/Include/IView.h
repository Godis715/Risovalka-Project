...
public:
	...
	virtual void DrawArc(const Vector2&, const Vector2&, const Vector2&) = 0;
	...
	virtual void DrawCircle(const Vector2&, const Vector2&) = 0;
	virtual void DrawCircle(const Array<double>&) = 0;

	virtual void DrawCurve(const Array<Vector2>&) = 0;
